"""Driver for TritonBench: iterates the suite, collects a baseline, and runs
perfxpert analysis on the captured trace. Emits analysis_summary.json.

This is the process-level glue; the runner module just calls this as a
subprocess and parses analysis_summary.json.
"""
