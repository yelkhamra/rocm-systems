...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_CDNA2_MUBUF_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_CDNA2_MUBUF_H_
...
class BufferInvl2Mubuf : public Mubuf {
public:
  BufferInvl2Mubuf(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
};
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_CDNA2_MUBUF_H_
