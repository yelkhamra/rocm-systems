...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_RDNA2_MUBUF_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_RDNA2_MUBUF_H_
...
class BufferAtomicCsubMubuf : public Mubuf {
public:
  BufferAtomicCsubMubuf(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand vdata;
  Operand vaddr;
  Operand srsrc;
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_RDNA2_MUBUF_H_
