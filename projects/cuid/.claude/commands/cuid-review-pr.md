---
description: Review a GitHub pull request using the CUID Review Agent
...
Review a GitHub pull request using the CUID Review Agent.
...
``` bash
/cuid-review-pr 123
/cuid-review-pr 123 style
/cuid-review-pr 123 tests security performance
/cuid-review-pr 123 fast
```
