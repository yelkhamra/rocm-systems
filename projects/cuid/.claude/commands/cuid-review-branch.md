---
description: Review the current local branch using the CUID Review Agent
...
Review the current local branch using the CUID Review Agent.
...
Invoke the **CUID Review Agent** with:
...
``` bash
/cuid-review-branch
/cuid-review-branch style
/cuid-review-branch tests security
/cuid-review-branch build
/cuid-review-branch fast
/cuid-review-branch skeptic
```
