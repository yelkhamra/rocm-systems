...
{
    banner("Test 7: Memory Advise Hints (hipMemAdvise)");
...
// ---------------------------------------------------------------------------
// Test 8: Read-Only Access Pattern
//
...
{
    banner("Test 8: Read-Mostly Pattern (concurrent read access)");
...
// ---------------------------------------------------------------------------
// Test 9: Multi-Kernel Stencil Pipeline
//
...
// ---------------------------------------------------------------------------
// Test 10: SAXPY with Managed Memory
//
...
// ---------------------------------------------------------------------------
// Test 11: Memory Pressure – many concurrent managed allocations
//
...
{
    banner("Test 11: Memory Pressure (oversubscription)");
...
// ---------------------------------------------------------------------------
// Test 12: Rapid Alloc/Free Cycling
//
...
{
    banner("Test 13: Prefetch Ping-Pong");
...
// ---------------------------------------------------------------------------
// Test 14: Multi-Stream Concurrent Access
//
...
// ---------------------------------------------------------------------------
// Test 16: Large Single Allocation
//
...
{
    banner("Test 16: Large Single Allocation");
