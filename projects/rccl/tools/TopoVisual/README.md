...
## Usage
Topology Visualizer accepts both RCCL log files or simulator output, i.e. [Topology Explorer](https://github.com/ROCm/rocm-systems/tree/develop/projects/rccl/tools/topo_expl "Topology Explorer").
