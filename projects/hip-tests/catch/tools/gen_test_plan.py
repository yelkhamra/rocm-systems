...
_THIS_DIR = os.path.dirname(os.path.abspath(__file__))         # catch/tools
CATCH_DIR = os.path.dirname(_THIS_DIR)                          # catch
TEST_PLAN_PATH = os.path.join(CATCH_DIR, "TEST_PLAN.md")
...
def render_markdown(cases, tiers):
    ...
    out.append("")
    out.append("Generated by `catch/tools/gen_test_plan.py` - **do not edit by "
...
def main(argv=None):
    ...
    parser.add_argument("--out", default=TEST_PLAN_PATH,
                        help="output path (default: catch/TEST_PLAN.md)")
