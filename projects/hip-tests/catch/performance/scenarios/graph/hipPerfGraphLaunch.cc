 ...
 * Test source
 * ------------------------
 * - performance/scenarios/graph/hipPerfGraphLaunch.cc
 *
 * Test requirements
 * ------------------------
 * - HIP_VERSION >= 6.4
 */
HIP_TEST_CASE(Performance_GraphWithMoreAllocFreeNodes_SingleBranchNoOperations) {
 ...
 * - HIP_VERSION >= 6.4
 */
HIP_TEST_CASE(Performance_GraphWithMoreAllocFreeNodes_SerialNodesSingleBranchWithOps) {
 ...
 * - HIP_VERSION >= 6.4
 */
HIP_TEST_CASE(Performance_GraphWithMoreAllocFreeNodes_MultipleBranches) {
 ...
 * - HIP_VERSION >= 6.4
 */
HIP_TEST_CASE(Performance_GraphWithMoreAllocFreeNodes_MultipleIndependentBranches) {
  constexpr int BRANCHES = 10;
 ...
 * - HIP_VERSION >= 6.4
 */
HIP_TEST_CASE(Performance_GraphWithMoreAllocFreeNodes_OneBranchNoOps_AutoFreeOnLaunch) {
  constexpr int SIZE = 1024;
