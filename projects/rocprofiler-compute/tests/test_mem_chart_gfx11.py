...
# =============================================================================
# Tests for format_bw_gbps function
# =============================================================================


class TestFormatBwGbps:
    """Tests for format_bw_gbps - expects input in Bytes/s."""

    def test_terabytes_per_second(self):
        """Test TB/s formatting."""
        result = mem_chart_gfx11.format_bw_gbps(1.5e12, 1)
        assert result == "1.5 TB/s"

    def test_gigabytes_per_second(self):
        """Test GB/s formatting."""
        result = mem_chart_gfx11.format_bw_gbps(256e9, 1)
        assert result == "256.0 GB/s"

    def test_megabytes_per_second(self):
        """Test MB/s formatting."""
        result = mem_chart_gfx11.format_bw_gbps(128e6, 1)
        assert result == "128.0 MB/s"

    def test_kilobytes_per_second(self):
        """Test KB/s formatting."""
        result = mem_chart_gfx11.format_bw_gbps(64e3, 1)
        assert result == "64.0 KB/s"

    def test_bytes_per_second(self):
        """Test B/s formatting."""
        result = mem_chart_gfx11.format_bw_gbps(512, 1)
        assert result == "512.0 B/s"

    def test_none_value(self):
        """Test handling of None values."""
        result = mem_chart_gfx11.format_bw_gbps(None, 1)
        assert result == "N/A"

    def test_invalid_value(self):
        """Test handling of invalid values."""
        result = mem_chart_gfx11.format_bw_gbps("not_a_number", 1)
        assert result == "N/A"
...
class TestGetMetric:
    """Tests for get_metric helper function."""

    def test_existing_key(self):
        """Test retrieval of existing key."""
        data = {"key1": 100, "key2": 200}
        assert mem_chart_gfx11.get_metric(data, "key1") == 100

    def test_missing_key_default(self):
        """Test default value for missing key."""
        data = {"key1": 100}
        assert mem_chart_gfx11.get_metric(data, "missing") is None
        assert mem_chart_gfx11.get_metric(data, "missing", 0) == 0

    def test_empty_dict(self):
        """Test with empty dictionary."""
        assert mem_chart_gfx11.get_metric({}, "key") is None
