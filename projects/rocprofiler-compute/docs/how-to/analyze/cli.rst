...
* **Navigation:** Drag to pan and scroll to zoom. Hovering over the plot reveals a menu in the top-right with tools to save the plot as a ``.png``, zoom in/out, and *Reset axes* (or double-click the chart) to return to the full view.
