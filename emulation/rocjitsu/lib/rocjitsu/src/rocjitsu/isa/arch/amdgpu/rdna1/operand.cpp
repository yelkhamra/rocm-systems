...
std::string Operand::name() const {
  ...
  case OperandType::OPR_SIMM8: {
    if (encoding_value_ == OpSelSimm8::OPR_SIMM8_SRC_SIMM8)
      return "src_simm8";
    break;
  }
  ...
  case OperandType::OPR_SREG_M0_INL: {
    ...
    if (encoding_value_ == OpSelSregM0Inl::OPR_SREG_M0_INL_FLOAT_ONE_OVER_TWO_PI)
      return "0.15915494";
    if (encoding_value_ == OpSelSregM0Inl::OPR_SREG_M0_INL_SRC_VCCZ)
      return "src_vccz";
    if (encoding_value_ == OpSelSregM0Inl::OPR_SREG_M0_INL_SRC_EXECZ)
      return "src_execz";
    if (encoding_value_ == OpSelSregM0Inl::OPR_SREG_M0_INL_SRC_SCC)
      return "src_scc";
    if (encoding_value_ == OpSelSregM0Inl::OPR_SREG_M0_INL_SRC_SHARED_BASE)
      return "src_shared_base";
    if (encoding_value_ == OpSelSregM0Inl::OPR_SREG_M0_INL_SRC_SHARED_LIMIT)
      return "src_shared_limit";
    if (encoding_value_ == OpSelSregM0Inl::OPR_SREG_M0_INL_SRC_PRIVATE_BASE)
      return "src_private_base";
    if (encoding_value_ == OpSelSregM0Inl::OPR_SREG_M0_INL_SRC_PRIVATE_LIMIT)
      return "src_private_limit";
    if (encoding_value_ == OpSelSregM0Inl::OPR_SREG_M0_INL_SRC_POPS_EXITING_WAVE_ID)
      return "src_pops_exiting_wave_id";
    break;
  }
