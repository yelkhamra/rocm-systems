...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_RDNA1_VOP3_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_RDNA1_VOP3_H_
...
class VMacLegacyF32Vop3 : public Vop3 {
public:
  VMacLegacyF32Vop3(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand vdst;
  Operand src0;
  Operand src1;
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_RDNA1_VOP3_H_
