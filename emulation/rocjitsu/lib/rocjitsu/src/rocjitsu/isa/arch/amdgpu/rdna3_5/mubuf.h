...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_RDNA3_5_MUBUF_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_RDNA3_5_MUBUF_H_
...
class BufferLoadLdsU8Mubuf : public Mubuf {
public:
  BufferLoadLdsU8Mubuf(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand vaddr;
  Operand srsrc;
  Operand soffset;
...
public:
  BufferLoadLdsI8Mubuf(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand vaddr;
  Operand srsrc;
  Operand soffset;
...
public:
  BufferLoadLdsU16Mubuf(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand vaddr;
  Operand srsrc;
  Operand soffset;
...
public:
  BufferLoadLdsI16Mubuf(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand vaddr;
  Operand srsrc;
  Operand soffset;
...
public:
  BufferLoadLdsB32Mubuf(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand vaddr;
  Operand srsrc;
  Operand soffset;
...
public:
  BufferLoadLdsFormatXMubuf(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand vaddr;
  Operand srsrc;
  Operand soffset;
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_RDNA3_5_MUBUF_H_
