...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_CDNA4_VOP2_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_CDNA4_VOP2_H_
...
class VDot2cF32Bf16Vop2 : public Vop2 {
public:
  VDot2cF32Bf16Vop2(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand vdst;
  Operand src0;
  Operand vsrc1;
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_CDNA4_VOP2_H_
