...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_RDNA3_5_SOP2_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_RDNA3_5_SOP2_H_
...
class SMinF32Sop2 : public Sop2 {
public:
  SMinF32Sop2(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand sdst;
  Operand ssrc0;
  Operand ssrc1;
...
class SMaxF32Sop2 : public Sop2 {
public:
  SMaxF32Sop2(const MachineInst *inst);
  void execute_impl(amdgpu::Wavefront &wf);
  Operand sdst;
  Operand ssrc0;
  Operand ssrc1;
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_RDNA3_5_SOP2_H_
