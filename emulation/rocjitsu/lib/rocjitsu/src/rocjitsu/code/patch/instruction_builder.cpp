...
[[nodiscard]] std::optional<uint8_t> scalar_sop2_opcode(rj_code_arch_t arch, ScalarSop2Op op) {
  ...
  case ROCJITSU_CODE_ARCH_GFX1250:
    ...
    return std::nullopt;
  case ROCJITSU_CODE_ARCH_RESERVED_0:
  case ROCJITSU_CODE_ARCH_RESERVED_1:
  case ROCJITSU_CODE_ARCH_RESERVED_2:
  case ROCJITSU_CODE_ARCH_RESERVED_3:
  case ROCJITSU_CODE_ARCH_RESERVED_4:
  case ROCJITSU_CODE_ARCH_RESERVED_5:
  case ROCJITSU_CODE_ARCH_RESERVED_6:
  case ROCJITSU_CODE_ARCH_RESERVED_7:
